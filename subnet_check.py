...
def prettyPrint(description, ip_comp, host, width):
    """
    Update of function created by Joe McManus
    This function is used to output the result in a formatted table.
    Future update will separate failed versus passing hosts
    """
